  ...
  return (
    <div className="app-ambient flex min-h-screen">
      <div className="flex w-full items-center justify-center px-10 py-16 lg:w-1/2">
        <div className="w-full max-w-sm rounded-2xl border t-border bg-[var(--bg-surface)] p-8 shadow-[0_0_40px_rgba(239,68,68,0.1)] backdrop-blur-md">
          <p className="mb-2 font-mono text-xs uppercase tracking-[0.18em] text-red-400">NexaHR</p>
          <h2 className="mb-6 text-2xl font-semibold t-text-heading">Sign In</h2>
              ...
              <InputField
                ...
                rightElement={
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 t-text-subtle hover:t-text-secondary"
                  >
          ...
          <p className="mt-5 text-sm t-text-muted">
      ...
      <div className="relative hidden w-1/2 items-center justify-center overflow-hidden border-l t-border lg:flex">
        ...
        <div className="relative z-10 text-center text-white">
          ...
          <p className="mt-4 font-mono text-sm t-text-muted">People operations, clearly organized.</p>
        </div>
      </div>
    </div>
  );
