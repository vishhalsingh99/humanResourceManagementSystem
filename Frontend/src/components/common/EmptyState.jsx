export default function EmptyState({ icon: Icon, message = 'No records found', colSpan }) {
  const content = (
    <div className="flex flex-col items-center justify-center gap-3 py-10 text-center text-neutral-500">
      {Icon && (
        <div className="flex h-16 w-16 items-center justify-center rounded-2xl border border-neutral-800 bg-neutral-900/60 text-red-400/80 shadow-[0_0_20px_rgba(239,68,68,0.1)]">
          <Icon size={28} />
        </div>
      )}
