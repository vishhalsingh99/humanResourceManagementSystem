...
export default function Header({
  ...
  return (
    <header
      className={`fixed inset-x-0 z-60 h-20 border-b border-neutral-800/80 bg-neutral-950/70 backdrop-blur-md ${
      ...
      <div className="flex w-full items-center justify-between px-4 py-3 lg:px-6">
        <div className="flex items-center gap-3">
          {!hideMenu && (
            <button
              ...
              className="flex h-9 w-9 cursor-pointer items-center justify-center rounded-xl text-neutral-300 transition hover:scale-[1.02] hover:bg-neutral-800/80 hover:text-white hover:shadow-[0_0_16px_rgba(239,68,68,0.15)]"
            >
          ...
          <div className="flex items-center gap-3 sm:flex">
            {companyLogo ? (
              <img
                src={companyLogo}
                alt="Company Logo"
                className="hidden h-10 w-10 object-contain sm:flex"
              />
            ) : (
            ...
            <p className="text-xl font-semibold tracking-tight text-white">{companyName}</p>
          </div>
        </div>
        ...
        <div className="relative">
          <button
            ...
            className="flex cursor-pointer items-center gap-3 rounded-xl px-1 py-1 text-neutral-200 transition hover:bg-neutral-800/70 sm:px-3"
          >
          ...
          {profileOpen && (
            <div className="absolute right-0 top-full z-50 mt-3.5 w-72 rounded-2xl border border-neutral-800/80 bg-neutral-900/95 shadow-[0_0_30px_rgba(239,68,68,0.12)] backdrop-blur-md">
              ...
              <div className="p-2">
                <button
                  ...
                  className="w-full rounded-xl px-4 py-3 text-left text-sm font-medium text-neutral-300 transition hover:bg-neutral-800 hover:text-red-300"
                >
                  Profile
                </button>
